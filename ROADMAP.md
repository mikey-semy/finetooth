...
Состояние на 23.09.2026: набор обкатан на **трёх проектах** (587 находок, одно ревью
...
замеры лежат в базе знаний проекта (`research/2026-09-23-review-methods.md`). Из него сюда
...
| 11 | фаза починки как гейт | замерено, что нужна; не начато |
...
6. **Направление 13** — модель угроз для ближайшего блока доступа.
