...
GitHub. Цифры — в [`docs/measurements.md`](docs/ru/measurements.md), разбор чужих решений по
каждому направлению — в [`docs/prior-art.md`](docs/ru/prior-art.md).
...
замеры — в [`docs/review-methods.md`](docs/ru/review-methods.md). Из него сюда
...
**Куда уходят токены — разбор 24.09** ([`docs/token-economy.md`](docs/ru/token-economy.md)).
...
Источники по каждому пункту — в [`docs/prior-art.md`](docs/ru/prior-art.md), наши цифры — в
[`docs/measurements.md`](docs/ru/measurements.md). Соседи на GitHub по каждому направлению и
чек-лист открытия репозитория — в [`docs/open-source.md`](docs/ru/open-source.md). Если цифра в этом файле разошлась с ними,
