...
The second fix review of block T4, eight more findings, all closed here. Five of them are in the guards the previous round had just written: each was green on exactly the state it exists to forbid.
