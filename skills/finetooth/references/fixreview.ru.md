...
11. **Скажи прямо, нужен ли следующий круг.** Мерило — не число находок, а что в проекте
    ...
    ведущая без нового круга. Скажи, сколько твоих находок внутри кода, изменённого прошлым
    кругом: если главная находка оказывается там два круга подряд и в одном классе,
    следующий ход — за человеком, а не за новым кругом.
...
Да/нет и почему — по мерилу из правила 11. Из находок выше: N — в коде, который менял
предыдущий круг, M — вне его. Это число нужно человеку, чтобы остановить: круги, которые
раз за разом находят дефекты в правках предыдущего круга, — петля, а не движение.
```
