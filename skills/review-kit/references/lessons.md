...
6. **Владение по каталогу прячет куски интерфейса.** Карточка сущности была собрана из
   локальных компонентов маршрута; владение каталогом отдало бы комментарии и карточку
   аварии блоку «карточка», и профильные блоки их не увидели бы. → Владение по файлу там,
