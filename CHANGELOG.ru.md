...
- Документы: [`docs/measurements.md`](docs/ru/measurements.md) — все замеры с методикой и
  границами переноса; [`docs/prior-art.md`](docs/ru/prior-art.md) — кто уже решал задачи из
  плана и что у них вышло, включая раздел «чем мерить нельзя»;
  [`ROADMAP.md`](ROADMAP.ru.md) — семь направлений и то, чего делать не стоит.
...
16.09.2026, разбор — в [`docs/how-it-works.md`](docs/ru/how-it-works.md)); здесь он приведён в
...
- Документы: [`docs/comparison-with-practice.md`](docs/ru/comparison-with-practice.md) — сверка
