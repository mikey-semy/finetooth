...
| A3 | верификатор даёт прирост | замерено: ложь отвергается вся, 6 из 6 |
...
**Чего по-прежнему не хватает:** сравнения при равном бюджете с двумя дешёвыми бейзлайнами —
(1) два независимых прохода охотника с объединением, (2) один проход плюс стадия
подтверждения исполнением. Никто в мире этого для поиска дефектов не мерил: ablation именно
по роли проверяющего на реальном коде не опубликован.
