[English version](../measurements.md)
...
неизвестно. Полноценный замер — в [`../../ROADMAP.ru.md`](../../ROADMAP.ru.md), направление 1; здесь
...
- **Сколько метод пропускает НАСОВСЕМ.** Раздел 5 даёт оценку снизу по двум законченным
  ...
  замера — в [`../../ROADMAP.ru.md`](../../ROADMAP.ru.md), направление 1.
