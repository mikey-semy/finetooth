...
341 scenarios, about six minutes, no dependencies other than `git`. Each one creates a fresh temporary
...
tests/test_review.py              tests of the tool and the skill format: 341 scenarios
