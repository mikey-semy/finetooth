...
334 scenarios, about seven minutes, no dependencies other than `git`. Each one creates a fresh temporary
...
tests/test_review.py              tests of the tool and the skill format: 334 scenarios
