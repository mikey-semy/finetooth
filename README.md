...
399 scenarios, about nine minutes, no dependencies other than `git`. Each one creates a fresh temporary
...
tests/                            tests of the tool and the skill format: 399 scenarios
